...
export default function generateHTMLReport(
  healthData: any,
  dateRange: any,
        ...
        <div class="info-grid">
          ...
          <div class="info-item">
            ...
            <div class="info-value">${
              healthData.patientAge || "Not specified"
            } ${healthData.patientAge ? "years" : ""}</div>
          </div>
          <div class="info-item">
            <div class="info-label">Gender</div>
            <div class="info-value">${
              healthData.patientGender || "Not specified"
            }</div>
          </div>
          <div class="info-item">
            <div class="info-label">Location</div>
            <div class="info-value">${
              healthData.patientCity || "Not specified"
            }</div>
          </div>
          <div class="info-item">
            <div class="info-label">Mobile</div>
            <div class="info-value">${
              healthData.patientMobile || "Not specified"
            }</div>
          </div>
          <div class="info-item">
            <div class="info-label">Job Type</div>
            <div class="info-value">${
              healthData.jobType || "Not specified"
            }</div>
          </div>
          <div class="info-item">
            <div class="info-label">Service Type</div>
            <div class="info-value">${
              healthData.serviceType || "Not specified"
            }</div>
          </div>
          <div class="info-item">
            ...
            <div class="info-value">
              <span class="badge ${
                healthData.status === "ongoing" ? "badge-success" : "badge-info"
              }">
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <div class="subtitle">
            ${format(new Date(dateRange.from), "d MMMM yyyy")} - ${format(
      ...
      if (entry.bloodPressure) {
        ...
        if (
          ...
          alerts.push({
            ...
            severity:
              diastolic > 100 || diastolic < 50 ? "Critical" : "Warning",
          });
        }
      }
      ...
      if (entry.heartRate) {
        ...
        if (
          ...
          alerts.push({
            ...
            severity:
              heartRate > 120 || heartRate < 40 ? "Critical" : "Warning", // Example critical values
          });
        }
      }
      ...
      if (entry.temperature) {
        ...
        if (
          ...
          alerts.push({
            ...
            severity:
              temperature > 101 || temperature < 96 ? "Critical" : "Warning",
          });
        }
      }
      ...
      if (entry.bloodSugar) {
        ...
        if (
          ...
          alerts.push({
            ...
            severity:
              bloodSugar > 200 || bloodSugar < 50 ? "Critical" : "Warning", // Example critical values
          });
        }
      }
    });
      ...
      ${alerts
        ...
        <div class="vitals-alert ${
          ...
          <div class="alert-text">
            ...
            ${format(new Date(alert.date), "MMM d,PPPP")} at ${
            alert.time
          } - Value: ${alert.value}
            <span class="badge ${
